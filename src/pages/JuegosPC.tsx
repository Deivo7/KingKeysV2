...
export function JuegosPC() {
  ...
  // Filter for PC games (games that have Steam, Epic Games, etc.)
  const pcProducts = products.filter((product) =>
    product.platforms.some((platform) =>
      ["Steam", "Epic Games", "Origin", "GOG", "Windows", "Mac", "PC"].includes(
        platform,
      ),
    ),
  );
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Juegos PC</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
  ...
  <div className="mb-8">
    <h1 className="text-3xl font-bold text-gray-900 mb-2">Juegos PC</h1>
    <p className="text-secondary-600">
      La mejor selección de juegos para PC con claves originales y entrega
      instantánea
    </p>
  </div>
</div>
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              ...
              {filteredProducts.length} juegos encontrados
            </span>
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-secondary-600">
                  No se encontraron juegos PC que coincidan con tus criterios.
                </p>
              </div>
            )}
          </div>
